...
public class Gears implements GLEventListener {
    ...
    public static void main(String[] args) {
        // set argument 'NotFirstUIActionOnProcess' in the JNLP's
        // application-desc tag for example
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        // MouseListener gearsMouse = new TraceMouseAdapter(new
        // GearsMouseAdapter());
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        if (GLProfile.isAWTAvailable() && (drawable instanceof com.jogamp.opengl.awt.GLJPanel) && !((com.jogamp.opengl.awt.GLJPanel) drawable).isOpaque() && ((com.jogamp.opengl.awt.GLJPanel) drawable).shouldPreserveColorBufferIfTranslucent()) {
